...
class CreateEnglishSonodsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('english_sonods', function (Blueprint $table) {
            ...
            $table->longText('amount_deails')->nullable();
            $table->text('the_amount_of_money_in_words')->nullable();
    ...
    {
        Schema::dropIfExists('english_sonods');
    }
}
